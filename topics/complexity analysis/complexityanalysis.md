...
Сколько операций мы выполним, чтобы пройтись по массиву? Для этого нужно колличетво проходов в первом цикле умножить на колличетво проходов во втором цикле, то есть $$ О(n×n)$$  или же $$ O(n^2) $$. Чтобы было нагляднее, представьте двумерный массив как квадрат со стороной **n**. Мы ищем площадь этого квадрата, то есть $$ n^2 $$.
